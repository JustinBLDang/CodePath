...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "K2Zh2Dp95OnGNpllMDAde0xjw", consumerSecret: "UL26bjmETC4T3pdGmWYe5qb5PQjajVzl3uPmwkq0A8IGkooEmE")
    var loginSuccess: (() -> ())?
